...
const Testimonials = () => {
  const feedback = [
    ...
    },
    {
      id: 4,
      name: "Sandesh Patil",
      image: "./client-image/teammemeber4.jpg",
      message: "Perfect for any occasion. Quick delivery and fresh cakes!",
    },
    {
      id: 5,
      image: "./client-image/teammemeber7.jpg",
      name: "Rohit Mohite",
      message: "Awesome and fresh cakes!",
    },
    {
      id: 6,
      image: "./client-image/teammemeber6.jpg",
      name: "Vivek Jadhav",
      message: "I ordered for a birthday, and it was a hit! Super fresh.",
    },
  ];
