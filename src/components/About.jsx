...
const About = () => {
  return (
    <>
      <div className="container mx-auto flex flex-wrap w-full pt-10 gap-6 sm:gap-0 sm:px-8 lg:justify-center">
        <div className="sm:w-[40%] lg:w-[30%] flex justify-center">
          <img className="w-[80%] sm:w-full" src="/Cake-Shop/slice.png" alt="slice cake" loading="lazy"/>
        </div>
